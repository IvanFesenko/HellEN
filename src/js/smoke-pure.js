...
void (function () {
  ...
  smoke.build = function (text, params) {
    if (typeof smoke.parent == 'undefined' || smoke.parent == null)
      smoke.parent = document.body;
    var ok = typeof params.ok != 'undefined' ? params.ok : smoke.ok;
    var cancel =
      typeof params.cancel != 'undefined' ? params.cancel : smoke.cancel;
    var point_event =
      typeof params.point_event != 'undefined'
        ? params.point_event
        : smoke.point_event;
    var parent =
      typeof params.parent != 'undefined' ? params.parent : smoke.parent;
    var zindex =
      typeof params.zindex != 'undefined' ? params.zindex : smoke.zindex;
    var reverse_buttons =
      typeof params.reverse_buttons != 'undefined'
        ? params.reverse_buttons
        : smoke.reverse_buttons;
    var autoexit =
      typeof params.autoexit != 'undefined' ? params.autoexit : smoke.autoexit;
    var autofocus =
      typeof params.autofocus != 'undefined'
        ? params.autofocus
        : smoke.autofocus;
    var custom_css =
      typeof params.custom_css != 'undefined'
        ? params.custom_css
        : smoke.custom_css;
    var css_prefix =
      typeof params.css_prefix != 'undefined'
        ? params.css_prefix
        : smoke.css_prefix;
    var input_default_value =
      typeof params.value != 'undefined' ? params.value : smoke.value;
    var callback =
      typeof params.callback != 'undefined' ? params.callback : smoke.callback;
    var observe_mutation =
      typeof params.observe_mutation != 'undefined'
        ? params.observe_mutation
        : smoke.observe_mutation;
    var window_opened =
      typeof params.window_opened != 'undefined'
        ? params.window_opened
        : smoke.window_opened;
    var window_closed =
      typeof params.window_closed != 'undefined'
        ? params.window_closed
        : smoke.window_closed;
    ...
    if (params.type == 'prompt') {
      var prompt = (obj.prompt = obj.dialog.prompt = document.createElement(
        'div',
      ));
      ...
      if (typeof input_default_value != 'undefined')
        prompt.input.value = input_default_value;
      prompt.appendChild(prompt.input);
      dialog.appendChild(prompt);
    }

    var buttons = (obj.buttons = obj.dialog.buttons = document.createElement(
      'div',
    ));
    ...
    if (typeof obj.prompt != 'undefined' && autofocus != false)
      obj.prompt.input.focus();
      ...
      if (typeof MutationObserver != 'undefined') {
        var observer = new MutationObserver(function (mutation_list) {
          for (var i = 0, curlen_i = mutation_list.length; i < curlen_i; i++) {
            ...
            for (
              var j = 0, curlen_j = mutation_item.removedNodes.length;
              j < curlen_j;
              j++
            ) {
  ...
  smoke.finishbuilding_alert = function (obj) {
    ...
    obj.buttons.ok.addEventListener(
      obj.params.point_event,
      ok_function_wrapper,
    );
  ...
  smoke.finishbuilding_confirm = function (obj) {
    ...
    obj.buttons.cancel.addEventListener(
      obj.params.point_event,
      cancel_function_wrapper,
    );
    obj.buttons.ok.smoke_pure_obj = obj;
  ...
  for (var i = 0; i < smoke.action_list.length; i++) {
    void (function (current_action) {
      smoke[current_action] = function (text, callback, params) {
        return smoke.build(
          text,
          merge_objects({ callback: callback, type: current_action }, params),
        );
      };
